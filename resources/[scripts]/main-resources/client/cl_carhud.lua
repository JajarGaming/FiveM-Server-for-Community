...
local HUD = {
	...
	RaceMode3		= false,	-- Enables/Disables The Race Mode HUD 3, only if the Race Mode and RaceMode2 are false 
	
	SeatBelt		= true,		-- Enables/Disables The seatbelt option (default key K) 
	
	Indicators		= true,		-- Enables/Disables The indicators option 
